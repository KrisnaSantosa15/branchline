...
import { getAnalysis, getScenario, getWorkspace, listMitigations } from "@/lib/persistence";
...
export async function POST(request: Request) {
  try {
    ...
    const artifact = exportReleaseBrief(workspace, analysis, scenario, listMitigations(analysis.id));
